...
-   Fix both Dockerfiles to use the correct port for the frontend
-   Fix build command in Frontend Dockerfile to properly generate and serve the React build with nginx
-   Fix both docker-compose files to use the correct port for frontend

# [0.9.5] (2025-09-06)

## Fixes

-   Fix backend PORT variable
-   Fix wrong credentials error on mobile login page
